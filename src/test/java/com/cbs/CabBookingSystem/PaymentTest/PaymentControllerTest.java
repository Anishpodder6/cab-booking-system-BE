...
class PaymentControllerTest {
    ...
    void testGetReceipt_Found() throws IOException {
        when(paymentService.getReceiptByPaymentId(rideId)).thenReturn(Optional.of(payment));
        ...
        verify(paymentService, times(1)).getReceiptByPaymentId(rideId);
    ...
    void testGetReceipt_NotFound() {
        ...
        when(paymentService.getReceiptByPaymentId(notFoundId)).thenReturn(Optional.empty());
        ...
        verify(paymentService, times(1)).getReceiptByPaymentId(notFoundId);
        try {
